...
\#### \[ ] S13 — Push notifications  ·  \*DIVIDIDA: \[x] S13a (registro de device token — backend) · \[ ] S13b (motor de push: Notification + PushService Expo + fila push-sender) · \[ ] S13c (mobile: registro + permissão + opt-out nos 2 apps)\*
