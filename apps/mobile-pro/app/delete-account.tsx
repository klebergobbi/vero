 ...
 * Trata o 409 (último gestor ativo da clínica não pode ser excluído).
 */
    ...
    try {
      ...
      if (err instanceof ApiError && err.status === 409) {
        Alert.alert(
          ...
          "Você é o último gestor ativo da clínica. Transfira a gestão antes de excluir sua conta.",
        );
      } else {
        Alert.alert(
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          Ao excluir sua conta, seus dados pessoais são anonimizados e seu
          acesso ao app é desativado.
        </Text>
        <Text style={styles.paragraph}>
          Registros da clínica que a lei obriga a manter (atendimentos, fiscais)
          são retidos pelo prazo legal, desvinculados da sua identidade quando
          possível.
        </Text>
