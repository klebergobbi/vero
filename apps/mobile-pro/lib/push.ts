/**
 * Push do App do Profissional (§S13c). Pede permissão (sempre a partir de uma AÇÃO
 * do usuário, com contexto — §5 loja), obtém o ExpoPushToken e registra no backend
...
const TOKEN_KEY = "vero_pro_push_token";
