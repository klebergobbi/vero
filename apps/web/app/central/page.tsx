...
export default async function CentralPage() {
  ...
  const [units, appointments, professionals, patients] = await Promise.allSettled([
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-4 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-indigo-700">Central de Agendamentos</h1>
          <p className="text-sm text-gray-500">Agende e visualize em todas as unidades autorizadas</p>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <SchedulingCenter
          ...
          professionals={professionals.status === "fulfilled" ? professionals.value : []}
