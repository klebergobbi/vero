      ...
      <section className="bg-white rounded-lg border p-6">
        ...
        >
          ...
          <div className="sm:col-span-2 lg:col-span-3 flex items-center gap-4">
            ...
            {state?.success && (
              <p className="text-sm text-green-600">Agendamento criado.</p>
            )}
          </div>
        </form>
      </section>
              ...
              <tbody className="divide-y">
                {appointments.map((a) => (
                  <tr key={a.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-0.5 rounded-full text-xs font-medium ${STATUS_COLOR[a.status] ?? "bg-gray-100 text-gray-600"}`}
                      >
